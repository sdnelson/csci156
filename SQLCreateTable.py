# Author: Steve Nelson
# Description: Connection to local PostgreSQL database and create a table
# File: SQLCreateTable.py
# Date: 11/23/2021
#
# Notes:
#
...
try:
    ...
    # Execute a statement
    cursor.execute(Commands.CREATETBL)

    # Fetch the message. It should be "CREATE TABLE" upon successful completion
